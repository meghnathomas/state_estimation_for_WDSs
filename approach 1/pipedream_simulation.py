...
def run_pipedream_simulation(inp, t_run=24, dt=3600, banded=False, num_iter=8, use_tank_init_cond=False):
    #Input path
    inp_file=inp  
...
#        # open link --> 1, close link --> 0
    ...
    return H_df, Q_df, Q_pump, model, Q_in_all_df #, pumps, superjunctions
