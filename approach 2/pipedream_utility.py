...
#        orifices = orifices.astype(orifices_row.dtypes.to_dict())
    ...
    if wn.num_pumps > 0:
        ...
        pumps=pd.DataFrame(columns=['name','id','sj_0','sj_1','z_p','dH_min','dH_max','a_p','b_p','c_p', 'init'], dtype=object)
...
#            
            ...
            pumps_row['b_p']=B
            pumps_row['c_p']=2
            pumps_init.append(pump.initial_status)
    ...
    return superjunctions, superlinks, orifices, pumps, prvs, H_bc, Q_in, pats, mult_df, tank_min, tank_max, tank_dict, time_controls_compiled, events_controls_pairs, pumps_init
